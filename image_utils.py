...
import cv2
def fit_image_within_box(input_path, output_path, target_width, target_height):
    # Open the image file
    original_image = Image.open(input_path)

    # Resize the image without degrading the quality
...
# Example usage
# resize_image("input_image.jpg", "output_resized_image.jpg", 300, 200)
